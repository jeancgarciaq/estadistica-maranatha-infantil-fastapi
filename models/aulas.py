...
class Aula(Base, AuditMixin):
    ...
    def __repr__(self):
        return f"<Aula(id={self.id}, auxiliar={self.auxiliar}, colaborador={self.colaborador}, condicion='{self.condicion}', maestra={self.maestra}, ninos={self.ninos}, ninas={self.ninas}, fecha='{self.fecha}', id_salon={self.id_salon})>"